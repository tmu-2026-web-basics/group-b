...
const managerData = {
  ...
  rikito: {
    ...
    items: [
      ...
      {
        title: "スーパーボール",
        href: "natsu/index.html?item=super"
      },

      {
        title: "CD",
        href: "nazo/index.html?item=cd"
      },

      {
        title: "うちわ",
        href: "natsu/index.html?item=uchiwa"
      },

      {
        title: "バズ・ライトイヤー",
        href: "aibou/index.html?item=buzz"
      }
  ...
  aimi: {
    ...
    items: [
      ...
      {
        title: "もやし",
        href: "sosyaku/index.html?item=moyashi"
      },
      ...
      {
        title: "ピックとハンカチ",
        href: "kurashi/index.html?item=pic"
      },

      {
        title: "玉ねぎ",
        href: "sosyaku/index.html?item=tamanegi"
      }
  ...
  koko: {
    ...
    items: [
      ...
      {
        title: "携帯用歯ブラシ",
        href: "kurashi/index.html?item=haburashi"
      },

      {
        title: "UVカットメガネ",
        href: "natsu/index.html?item=megane"
      },

      {
        title: "濃い緑茶",
        href: "sosyaku/index.html?item=ocha"
      },

      {
        title: "たくさんのきゅうり",
        href: "sosyaku/index.html?item=kyuuri"
      }
  ...
  nodoka: {
    ...
    items: [
      ...
      {
        title: "サドルカバー",
        href: "aibou/index.html?item=sadoru"
      },

      {
        title: "日傘カバー",
        href: "natsu/index.html?item=kasa"
      },

      {
        title: "手作りお守り",
        href: "aibou/index.html?item=anpanman"
      },

      {
        title: "ボールペン",
        href: "kurashi/index.html?item=pen"
      }
  ...
  takaharu: {
    ...
    items: [
      ...
      {
        title: "軍手",
        href: "kurashi/index.html?item=gunte"
      },

      {
        title: "スクイーズ",
        href: "nazo/index.html?item=sukuizu"
      },

      {
        title: "羽",
        href: "nazo/index.html?item=hane"
      },
      {
        title: "熊のぬいぐるみ",
        href: "aibou/index.html?item=kuma"
      }
